...
namespace MyEpiserverSite.Business.Channels
{
    public class MobileDisplayChannel : DisplayChannel
    {
        public override bool IsActive(HttpContextBase context)
        {
            return context.Request.IsComingFromMobile();
        }
    ...
    public static class MobileDisplayChannelExtensions
    {
        ...
        public static bool IsComingFromMobile(this HttpRequestBase request)
        {
